                            ...
                            <>
                                <Row className="sr-space" justify='center' gutter={[16, 16]}>
                                    <Col style={{ textAlign: 'left', paddingLeft: 30 }} span={8} offset={4}>
                                        ...
                                        <h4 style={{marginTop: 10}}>Thời gian làm việc: {value.time}</h4>
                                        <div className="address">Địa chỉ: {value.address} </div>
                                        <iframe src={value.map} width="568.328" height="260" style={{ border: 0 }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </Col>
                                    <Col span={12}>
                                        <div>
                                            <Image className="pic"
